...
public class RatingService {
    ...
    private AuditEvent buidlAuditEvent(Rating saved, Actions actions, BookStarUserDetails user) {
        return new AuditEvent(LocalDateTime.now(), Entities.RATING.name(), saved.getId().getValue(), actions.name(), user.getUsername(), "Score: " + saved.getScore().getValue());
    }
}
